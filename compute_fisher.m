...
for j=1:length(file_list)
	...
	file=fullfile(act_dir,[clip_name,'.features.gz']);
	...
	fv_hog=fisher_encode_vgg(HOG,pca_coeff{1},gmm{1},fisher_params);%feisheer xiangliang keyi jiaru daima jinxing baocun
	...
	fv=[fv_hog;fv_hof;fv_MBHx;fv_MBHy];%dan ge shipin de fv
	fvt=[fvt fv]; % concatenate all features together,suoyou shipin de fv
end
