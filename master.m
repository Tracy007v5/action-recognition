...
clc;
clear;
run('/home/wcj/software/vlfeat-0.9.20/toolbox/vl_setup')
path='/home/wcj/code/dtf_fisher-master';
addpath(fullfile('/home/wcj/software/yael_v438/yael'));
addpath(fullfile('/home/wcj/software/yael_v438/matlab'));
addpath(fullfile('/home/wcj/software/libsvm-3.21'));
addpath(fullfile('/home/wcj/software/libsvm-3.21/matlab'));
addpath(fullfile('/home/wcj/code/dtf_fisher-master/vgg_fisher'));
addpath(fullfile('/home/wcj/code/dtf_fisher-master/vgg_fisher/lib/gmm-fisher/matlab'));
...
params.dtf_dir=fullfile('/home/wcj/UCF101_DTF');
...
switch params.encoding
      case 'fisher'        
        ...
        if ~exist(params.fv_train_file,'file') && ~exist(params.fv_test_file,'file')
            ...
            load(params.fv_train_file); %pca_coffe :1*4cell,48*96,54*108,48*96,48*96
        end
        ...
        for i=1:numel(uniq_labels)%xuan de bazu ceshi ,i yici ceshi meiyizu
            % Process training files
            pos_idx=(all_train_labels == i);%anzhao biaoqian chuli xunlian wenjian 
            pos_files=all_train_files(pos_idx); % positive training files
            fvt_pos_train=compute_fisher(params, pca_coeff, gmm, pos_files);%jisuan xunlian wenjian de feisheer xiangiang
            
            neg_idx=(all_train_labels ~= i);%huoqu xunlian yangben de biaoqian 
            neg_files=all_train_files(neg_idx);
            sample_idx=randperm(length(neg_files),length(pos_files));%zai xunlian yangben zhong suiji xuanle 104 ge wenjian 
            ...
            pos_files=all_test_files(pos_idx); % positive training files,disanzu ceshi wenjian 
            ...
            sample_neg_files=neg_files(sample_idx);
            fvt_neg_test=compute_fisher(params, pca_coeff, gmm, sample_neg_files);%ceshi de feisheer xiangliang
